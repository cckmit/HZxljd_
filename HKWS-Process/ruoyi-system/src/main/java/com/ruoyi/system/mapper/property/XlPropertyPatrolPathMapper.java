 ...
 * @date 2021-05-27
 */
public interface XlPropertyPatrolPathMapper
{
    /**
     * 查询物业-巡更路线
     *
     ...
     * 批量删除物业-巡更路线
     *
     * @param pathIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteXlPropertyPatrolPathByIds(String[] pathIds);
     ...
     * @return
     */
    public int deletePathByIds(String[] pathIds);
}
