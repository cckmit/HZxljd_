 ...
 * @date 2021-05-27
 */
public interface IXlPropertyPatrolPlanService
{
    /**
     * 查询物业-巡更计划
     *
    ...
    List<XlPropertyPatrolPlan> selectXlPropertyPatrolPlanListByproperty(Integer[] villageId,XlPropertyPatrolPlan xlPropertyPatrolPlan);
}
