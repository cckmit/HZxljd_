...
public class UserConstants
{
    ...
    /** 区域名称是否唯一的返回结果码 */
    public final static String REGION_NAME_UNIQUE = "0";
    public final static String REGION_NAME_NOT_UNIQUE = "1";
    ...
    /** 自定义标签是否唯一的返回结果码 */
    public final static String CUSTOM_LM_NAME_UNIQUE = "0";
    public final static String CUSTOM_LM_NAME_NOT_UNIQUE = "1";

    /** 标签是否唯一的返回结果码 */
    public final static String LM_NAME_UNIQUE = "0";
    public final static String LM_NAME_NOT_UNIQUE = "1";
    /**
     * 密码长度限制
     */
