 ...
 */
@Controller
@RequestMapping("/system/property/event/feedback")
public class FeedBackEventController extends BaseController {

    private String prefix = "system/property/event/feedback";
    ...
    @RequiresPermissions("system/property/event:feedback:view")
    @GetMapping()
     ...
     * 查询物业--事件信息列表
     */
    @RequiresPermissions("system/property/event:feedback:list")
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(XlPropertyEvent xlPropertyEvent)
    {
        startPage();
        //意见反馈事件
        xlPropertyEvent.setEventSource(2);
     ...
     * 导出物业--事件信息列表
     */
    @RequiresPermissions("system/property/event:feedback:export")
