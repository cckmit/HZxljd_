 ...
 */
@Controller
@RequestMapping("/system/property/event/repairs")
public class RepairsEventController extends BaseController {

    private String prefix = "system/property/event/repairs";
    ...
    @RequiresPermissions("system/property/event:repairs:view")
    @GetMapping()
     ...
     * 查询物业--事件信息列表
     */
    @RequiresPermissions("system/property/event:repairs:list")
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(XlPropertyEvent xlPropertyEvent)
    {
        startPage();
        //报修维护事件
        xlPropertyEvent.setEventSource(3);
     ...
     * 导出物业--事件信息列表
     */
    @RequiresPermissions("system/property/event:repairs:export")
    ...
    public AjaxResult export(XlPropertyEvent xlPropertyEvent)
    {
        ...
        return util.exportExcel(list, "repairs");
    }
