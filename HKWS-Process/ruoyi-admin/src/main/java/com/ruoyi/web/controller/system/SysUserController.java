...
public class SysUserController extends BaseController
{
    ...
    public String add(ModelMap mmap)
    {
        ...
        mmap.put("posts", JSON.toJSONString(postService.selectPostAll()));
        return prefix + "/add";
    }
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap)
    {
        ...
        mmap.put("posts", JSON.toJSONString(postService.selectPostAll()));
        Map<String,List<SysUserPostRegion>> userPostRegionStr = new HashMap<>();
        List<SysUserPostRegion> sysUserPostRegionList = iSysUserPostRegionService.selectSysUserPostRegionById(userId);
        ...
        mmap.put("userPostRegionStr", JSON.toJSONString(userPostRegionStr));
        return prefix + "/edit";
    }
    ...
    public AjaxResult userDetail(Long userId)
    {
        ...
        List<UserInfoDto> userInfoDtos = userService.selectCanBeChoose(params);*/
        UserInfoDto userInfoDto = new UserInfoDto();
        SysUser user = userService.selectUserById(userId);
        if(user != null){
            userInfoDto.setUserName(user.getUserName());
            userInfoDto.setPhone(user.getPhonenumber());
            userInfoDto.setSex(Integer.parseInt(user.getSex()));
            userInfoDto.setDeptName(user.getDept().getDeptName());
        }
